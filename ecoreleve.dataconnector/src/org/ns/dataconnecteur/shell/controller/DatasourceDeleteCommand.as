package org.ns.dataconnecteur.shell.controller
{
    ...
    public class DatasourceDeleteCommand extends SimpleFabricationCommand
    {
    	...
    	{    		         	
			...
			pxyDatasource.deleteDatasource(pxyDatabase.getSqlConnexion,note.getBody() as RemoteDatasourceVO);
