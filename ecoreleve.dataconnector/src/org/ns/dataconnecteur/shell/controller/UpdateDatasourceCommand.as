package org.ns.dataconnecteur.shell.controller
{
    ...
    public class UpdateDatasourceCommand extends SimpleFabricationCommand
    {
    	...
    	{    		         	
			...
			pxyDatasource.update(pxyDatabase.getSqlConnexion,note.getBody() as RemoteDatasourceVO);
