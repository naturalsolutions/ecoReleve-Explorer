package com.pocketListGenerator.view
{
	...
	import com.pocketListGenerator.view.mycomponents.UpdatePanel;
	...
	public class UpdatePanelMediator extends Mediator implements IMediator
	{
		//nom du médiator
        ...
        **/
		private function onUpdateStatus(event:StatusUpdateEvent):void
		{
			...
			if ( event.available ) {
				// show panel
				sendNotification(ApplicationFacade.DISPLAY_UPDATE_PANEL,true)
				updatepanel.strVersion=event.version;
			}else {
				//application is up to date
				sendNotification(ApplicationFacade.DISPLAY_UPDATE_PANEL,false)
